...
<interface>  
  <template slot="fixed-nav-bar">
         <li><a href="/" class="btn transparent white-text waves-effect waves-light">Home</a></li>
          ...
          <li><a  class="btn transparent white-text waves-effect waves-light" @click="this.logout()">
          Logout
          </a>
          </li>
      </template>
            ...
            <div class="row ">
              <form action="" class="search-drug">
                <div class="input-field col s12">
                  ...
                  <input type="search" id="autocomplete-input" class="autocomplete" placeholder="Search your prescribed drug here!"/>
                </div>
              </form>
